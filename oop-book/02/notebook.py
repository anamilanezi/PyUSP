...
class Note:
    """Represent a note in the notebook. Match against a string in searches and store tags for each one"""
    ...
    def match(self, filter):
        ...
        Search is case sentitive and matches both text and tags"""
