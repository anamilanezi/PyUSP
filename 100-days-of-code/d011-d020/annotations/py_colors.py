ALL_COLORS = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
...
selected_colors = ['dark turquoise', 'light sea green', 'cadet blue', 'teal', 'sea green', 'spring green',
                   'orange red', 'crimson', 'dark orchid', 'medium violet red', 'dark orchid', 'slate blue']

angela_colors = ["CornflowerBlue", "DarkOrchid", "IndianRed", "DeepSkyBlue", "LightSeaGreen", "wheat", "SlateGray",
                 "SeaGreen"]